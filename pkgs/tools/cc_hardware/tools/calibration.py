...
def tmf8828_calibrate(filename: str, port: str | None = None):
    ...
    from cc_hardware.drivers.spads.tmf8828 import TMF8828Sensor, SPADID, RangeMode
    ...
    for spad_id in spad_ids:
        for range_mode in range_modes:
            ...
            data.extend(calibrate(partial(TMF8828Sensor, spad_id=spad_id, range_mode=range_mode)))
